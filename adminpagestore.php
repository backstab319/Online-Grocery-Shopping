...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggle">
                    <div class="navbar-menu ml-auto">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/adminpage.php">Manage Orders</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container jumbotron text-center col-lg-6 col-xl-6">
        ...
        <p class="lead text-justify text-center">Please use the tools given below to manage the grocery store items</p>
    </div>

    <div class="container text-center col-lg-6 col-xl-6" id="add">
    <h1 class="display-4">Add new item to the store</h1>
        <div class="form-group d-flex justify-content-center">
            <form action="adminpagestore.php" method="POST">
